...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GroupSharedLink'
        db.create_table(u'social_network_groupsharedlink', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='(app_label)s_groupsharedlink_set_post', to=orm['auth.User'])),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(related_name='(app_label)s_groupsharedlink_set_post', to=orm['social_network.SocialGroup'])),
            ('comment', self.gf('django.db.models.fields.TextField')()),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
        ))
        db.send_create_signal('social_network', ['GroupSharedLink'])


    def backwards(self, orm):
        # Deleting model 'GroupSharedLink'
        db.delete_table(u'social_network_groupsharedlink')
    ...
    models = {
        ...
        'social_network.groupsharedlink': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'(app_label)s_groupsharedlink_set_post'", 'to': "orm['social_network.SocialGroup']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
