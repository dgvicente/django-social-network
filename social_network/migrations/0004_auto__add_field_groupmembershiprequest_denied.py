...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupMembershipRequest.denied'
        db.add_column(u'social_network_groupmembershiprequest', 'denied',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupMembershipRequest.denied'
        db.delete_column(u'social_network_groupmembershiprequest', 'denied')
