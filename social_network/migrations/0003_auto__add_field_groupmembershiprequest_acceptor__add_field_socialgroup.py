...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GroupMembershipRequest.acceptor'
        db.add_column(u'social_network_groupmembershiprequest', 'acceptor',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='accepted_group_memberships', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'SocialGroup.created'
        db.add_column(u'social_network_socialgroup', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2015, 1, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GroupMembershipRequest.acceptor'
        db.delete_column(u'social_network_groupmembershiprequest', 'acceptor_id')

        # Deleting field 'SocialGroup.created'
        db.delete_column(u'social_network_socialgroup', 'created')
